...
import { diasSemana } from '../utils/constants'; // puedes moverlo ahí si se repite
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-800 to-fuchsia-400 flex items-center justify-center px-4">
      <FormContainer maxWidth="max-w-5xl">
                ...
                <div key={dia} className="flex items-center gap-4">
                  ...
                  {disponiblesDia.length > 0 ? (
                    <select
                      ...
                      onChange={(e) =>
                        setAsignacionPorDia(prev => ({ ...prev, [dia]: e.target.value || null }))
                      }
        ...
        <img
          ...
          alt="Huella gato"
          className="absolute bottom-8 right-8 w-28 opacity-90 pointer-events-none select-none"
        />
        <img
